...
<div class="container">
    <div class="row">
          ...
          <div class="tab-content">
            ...
            <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0">
              ...
              <div class="form-group">
                ...
                <input type="text" id="search" class="form-control" placeholder="Search our books by title here" required>
     ...
     <div class="pull-right">
        ...
        <input type='button' class='btn btn-finish btn-fill btn-info btn-wd btn-sm' id="signup" name='signup' value='Search' />
...
<div id="video_holder">
<video autoplay loop poster="video/snap.png" id="bgvid">
