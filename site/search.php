...
<div class="container">
    <div class="row">
          ...
          <div class="tab-content">
            ...
            <div class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0">
              ...
              <div class="form-group">
                ...
                <input type="text" id="search_text" class="form-control" placeholder="Search our books by title here" required>
     ...
     <div class="pull-right">
        ...
        <input type='button' class='btn btn-finish btn-fill btn-info btn-wd btn-sm' id="title" name='search' value='Search By Title' />
        <input type='button' class='btn btn-finish btn-fill btn-info btn-wd btn-sm' id="author" name='search' value='Search By Author' />
...
$("#title").click(function(){
	...
	var src_text = $("#search_text").val();
	console.log(src_text);
	
	window.location = 'https://localhost/site/search_result.php?title='+ src_text;
});
...
$("#author").click(function(){
	...
	window.location = 'https://localhost/site/search_result.php?author='+ src_text;
});
